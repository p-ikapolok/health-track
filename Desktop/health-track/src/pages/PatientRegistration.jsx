  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="flex flex-col items-center px-4 py-8">
        <h2 className="text-3xl font-bold mb-10">Patient Registration</h2>
        ...
        <form className="w-full max-w-md space-y-6">
          ...
          <div>
            ...
            />
            <select className="w-full p-2 border border-gray-500 bg-transparent rounded-sm mb-4">
          ...
          <div>
            ...
            <textarea
              placeholder="Briefly Describe Any Significant Medical Conditions"
              className="w-full p-2 border border-gray-500 bg-transparent rounded-sm"
              rows="3"
            ></textarea>
          </div>
